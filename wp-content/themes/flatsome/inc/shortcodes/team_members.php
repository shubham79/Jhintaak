...
function team_member($atts, $content = null) {
    ...
    <div class="social-icons">
		...
		<?php }?>
		<?php if($instagram){?> 
		       <a href="<?php echo $instagram; ?>" target="_blank" class="icon icon_instagram tip-top" data-tip="<?php echo $instagram; ?>"><span class="icon-instagram"></span></a>
		<?php }?>
		<?php if($linkedin){?> 
		       <a href="<?php echo $linkedin; ?>" target="_blank" class="icon icon_linkedin tip-top" data-tip="<?php echo $linkedin; ?>"><span class="icon-linkedin"></span></a>
		<?php }?>
     </div>
