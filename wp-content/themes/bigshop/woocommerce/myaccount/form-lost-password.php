...
<form method="post" class="lost_reset_password" role="form">
    ...
    <div class="form-group">
        <input type="submit" class="button btn btn-default btn-theme-default" name="wc_reset_password" value="<?php echo 'lost_password' == $args['form'] ? __( 'Reset Password', 'woocommerce' ) : __( 'Save', 'woocommerce' ); ?>" />
    </div>
