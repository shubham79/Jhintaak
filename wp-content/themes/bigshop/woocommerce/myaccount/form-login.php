...
<?php endif; ?>
		...
		<form method="post" class="login" role="form">
			...
			<div class="form-group">
				...
				<input type="submit" class="button btn btn-default btn-theme-default" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" /> 				
			</div>
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		...
		<form method="post" class="register" role="form">
			...
			<div class="form-group">
				...
				<input type="submit" class="button btn btn-default btn-theme-default" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
			</div>
